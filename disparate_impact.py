...
Output: a Disparate Impact less than 1 is a bias against an attribute class, while a DI greater than 1 is a bias *for*
...
def Disparate_Impact(dataset, attribute, target, reference=None, target_value=None):
    ...
    for comp in attribute_components:
        if comp == reference:
            ...
            print("The Disparate Impact for the protected attribute " + comp + " is ", disp_imp)
